...
func (m *SnippetModel) Insert(title string, content string, expires int) (int, error) {
	...
	stmt := `INSERT INTO snippets (title, content, created, expires)
    VALUES($1, $2, CURRENT_TIMESTAMP AT TIME ZONE 'UTC', (CURRENT_TIMESTAMP AT TIME ZONE 'UTC') + ($3 || ' days')::interval) RETURNING id`

	// Instead of Exec(), use QueryRow() to get the returned id
	var id int
